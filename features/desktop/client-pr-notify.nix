{
  ...
  home = {
    ...
    tokenPath =
      if cfg.githubTokenPath != null
      then cfg.githubTokenPath
      else if osConfig != null
      then lib.attrByPath ["sops" "secrets" cfg.sopsSecretName "path"] null osConfig
      else null;
  ...
  in {
    ...
    systemd.user.services.qnix-client-pr-notify = lib.mkIf cfg.enable {
      ...
      Service = {
        ...
        Environment = lib.optionalAttrs (tokenPath != null) {
