...
| `system.localisation` | NixOS | `base`, `workstation` | — | — | planned | Locale, timezone, keyboard |
...
- `contracted` — public contract agreed
- `implemented` — feature descriptor exists
- `tested` — evaluation coverage exists
- `migrated` — consumers use the SDK feature
- `removed` — intentionally excluded from the new module set
